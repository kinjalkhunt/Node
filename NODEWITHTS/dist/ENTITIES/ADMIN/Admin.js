...
let Admin = (() => {
    let _classDecorators = [(0, typeorm_1.Entity)({ name: 'admin' })];
    ...
    (() => {
        ...
        _name_decorators = [(0, typeorm_1.Column)({ type: 'varchar', length: 30 })];
        _email_decorators = [(0, typeorm_1.Column)({ type: 'varchar', length: 30 })];
        _createdAt_decorators = [(0, typeorm_1.UpdateDateColumn)({ type: 'timestamp' })];
